    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container-mobile py-6 md:py-8">
        ...
        {/* 
          ...
          - Categoría (category_id): select de categories WHERE type IN ('income', 'both')
          - Fuente (source_id): select de sources WHERE type IN ('income', 'both')
          ...
          3. Enviar datos con type = 'income' y created_by = user.id
